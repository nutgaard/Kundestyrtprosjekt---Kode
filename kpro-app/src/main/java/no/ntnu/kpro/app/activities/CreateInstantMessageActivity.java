...
private void resetFields() {
    ...
    private boolean doSendButtonValidation() {
        ...
        Toast sendMessageError = Toast.makeText(CreateInstantMessageActivity.this, R.string.invalidSecurityLabelError, Toast.LENGTH_LONG);
        ...
        txtReceiver.addTextChangedListener(
                new TextWatcher() {
                    public void onTextChanged(CharSequence cs, int i, int i1, int i2) {
                        CreateInstantMessageActivity.this.textEnteredInReceiver = true;
                    }
    ...
    private void addReceiverOnFocusChangedListener(EditText receiver) {
        final CreateInstantMessageActivity t = this;
    ...
    private void addClickListener(Button btnAddAttachment) {
        ...
        btnAddAttachment.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(CreateInstantMessageActivity.this, android.R.layout.select_dialog_item, items);
                AlertDialog.Builder builder = new AlertDialog.Builder(CreateInstantMessageActivity.this);
    ...
    @Override
        ...
        if (requestCode == PICK_VOICE_RECORDING) {
            ...
            Toast.makeText(CreateInstantMessageActivity.this, "Saved: " + soundRecordingUri.getPath(), Toast.LENGTH_LONG).show();
        }
