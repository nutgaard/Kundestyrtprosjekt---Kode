...
public class Mail extends javax.mail.Authenticator implements NetworkService {    
    ...
    public Mail() {        
        ...
        _user = "nutgaard@gmail.com"; // username 
        _pass = "XXXXXXXXXXX"; // password 
    ...
    public void sendMail(String _subject, String _body, String _from, String to) {        
        Properties props = _setProperties();        
        _to = to.split(",");
        Log.i("KPRO", "Mail::sendMail");
        if (!_user.equals("") && !_pass.equals("") && _to.length > 0 && !_from.equals("") && !_subject.equals("") && !_body.equals("")) {            
            try {
                Log.i("KPRO", "Data is valid");
